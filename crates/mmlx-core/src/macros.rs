...
static VALID_PARAM_KEYS: Lazy<HashSet<&'static str>> = Lazy::new(|| {
    [
        ...
        "op3_mult", "op3_wave", "op3_egt",
        "op4_mult", "op4_wave", "op4_egt",
        "op1_dt", "op1_tl", "op1_ar", "op1_dr", "op1_sr", "op1_sl", "op1_rr", "op1_ssg",
        "op2_dt", "op2_tl", "op2_ar", "op2_dr", "op2_sr", "op2_sl", "op2_rr", "op2_ssg",
        "op3_dt", "op3_tl", "op3_ar", "op3_dr", "op3_sr", "op3_sl", "op3_rr", "op3_ssg",
        "op4_dt", "op4_tl", "op4_ar", "op4_dr", "op4_sr", "op4_sl", "op4_rr", "op4_ssg",
        "ym_algo", "ym_feedback", "ym_fnum", "ym_block", "ym_channel",
        "opl_alg",
        "opl_feedback",
        "ay_channel",
        "ay_volume",
